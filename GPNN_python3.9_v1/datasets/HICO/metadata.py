...
def main():
    ...
    # Test COCO-to-HICO and HICO-to-COCO mappings
    assert coco_to_hico[1] == hico_classes.index('person')
    assert hico_to_coco[1] == coco_classes.index('airplane')
    print("COCO-to-HICO and HICO-to-COCO mappings passed.")

    # Test HOI-to-action mapping
    assert hoi_to_action[0] == action_classes.index('board')
    print("HOI-to-action mapping passed.")

    # Test object-to-HOI mapping
    obj_class = 2  # Example object class
    action_hico = action_classes.index('hold')
    obj_idx = action_to_obj_idx(obj_class, action_hico)
    print(hico_classes[obj_class])
    print(obj_idx,obj_hoi_index[obj_class][0] - 1)
    assert obj_idx == obj_hoi_index[obj_class][0] - 1
    print("Object-to-HOI mapping passed.")
